...
<div class="block-header">
    <div class="clearfix mb-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.subjects') }}">MentorQu</a></li>
                <li class="breadcrumb-item active" aria-current="page">Kelola Manage Kursus</li>
            </ol>
        </nav>
        <h1 class="color-blue-2 font-weight-bold my-4" style="font-size: 1.8rem;">Kelola Manage Kursus</h1>
    </div>
    <div class="row clearfix">
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#mapel">Manage Kursus</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addSubject">Tambah M</a></li>
                </ul>
